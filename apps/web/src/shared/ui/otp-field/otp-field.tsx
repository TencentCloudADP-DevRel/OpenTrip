...
export function OTPFieldInput({
  ...
  return (
    <OTPFieldPrimitive.Input
      className={cn(
        "relative size-10 min-w-0 rounded-lg border border-input bg-card text-center text-base leading-10 text-foreground",
        "in-[[data-slot=otp-field][data-size=default]]:size-9 in-[[data-slot=otp-field][data-size=default]]:leading-9 in-[[data-slot=otp-field][data-size=default]]:text-sm",
